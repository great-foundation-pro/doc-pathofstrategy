---
title: Глава 10. Формы местности
...
Сунь-цзы сказал: местность по форме бывает открытая, бывает наклонная[66] , бывает 

64 65 66 

пересеченная, бывает долинная, бывает гористая, бывает отдаленная. 
